...
export default class RegisterComponent extends Component {
  ...
  handleRegister = () => {
    if (this.state.password != this.setState.confirmPassWord) {
      Alert.alert(
        "Warning",
        "vui lòng điền password và confirm password giống nhau",
        [{ text: "OK" }],
        {
          cancelable: true,
        }
      ...
      Alert.alert(
        "Warning",
        "vui lòng điền email, password và confirm password",
        [{ text: "OK" }],
        {
          cancelable: true,
        }
    ...
    return (
      <>
        ...
        <View style={styles.container}>
          <Image
            source={require("../../../assets/GardenManager.png")}
          ...
          <Text style={styles.warning}>
            Please fill in all fields before register
          </Text>
