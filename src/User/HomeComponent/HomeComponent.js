      ...
      <View style={styles.container}>
        ...
        <View style={styles.body}>
          <View style={styles.infor}>
            <View style={styles.avata}>
              <Image
                source={require("../../../assets/Avata/ronaldo.jpg")}
                style={{
                  width: "100%",
                  height: "100%",
                  aspectRatio: 1,
            ...
            {this.state.menu.map((e, i) => {
              return (
                <View key={i} style={styles.item}>
                  <TouchableOpacity
                    style={styles.intemImg}
                    onPress={() => this.handleChosen(e.Id)}
                  >
                    <Image
                      source={e.Icon}
        ...
        <View style={styles.footer}>
          <View style={styles.boxfooter}>
            <TouchableOpacity
              style={styles.col}
              onPress={() => this.handleController(1)}
            >
              <Icon
                name="home"
                size={30}
                color={this.state.controller == 1 ? "#18F33B" : "#000"}
              />
              <Text
                style={{
                  color: this.state.controller === 1 ? "#18F33B" : "#000",
            ...
            <TouchableOpacity
              style={styles.col}
              onPress={() => this.handleController(2)}
            >
              <Icon
                name="search"
                size={30}
                color={this.state.controller == 2 ? "#18F33B" : "#000"}
              />
              <Text
                style={{
                  color: this.state.controller === 2 ? "#18F33B" : "#000",
            ...
            <TouchableOpacity
              style={styles.col}
              onPress={() => this.handleController(3)}
            >
              <Icon
                name="user"
                size={30}
                color={this.state.controller == 3 ? "#18F33B" : "#000"}
              />
              <Text
                style={{
                  color: this.state.controller === 3 ? "#18F33B" : "#000",
